        ...
        <div className="space-y-8">
            ...
            <div className="border rounded-md">
                <Table>
                    ...
                    <TableBody>
                        {scholarshipTypes?.map((type: ScholarshipType) => (
                            <TableRow key={type.id}>
                                ...
                                <TableCell>
                                    <Badge variant={type.is_active ? "default" : "secondary"}>
                                        {type.universities?.name || "Unknown University"}
                                    </Badge>
                                </TableCell>
                        ...
                        {(!scholarshipTypes || scholarshipTypes.length === 0) && (
                            <TableRow>
                                <TableCell colSpan={7} className="text-center py-8 text-muted-foreground">
                                    <p className="text-sm">Click &quot;Add Scholarship Type&quot; to create a new scholarship category</p>                               </TableCell>
                            </TableRow>
                        )}
                    </TableBody>
                </Table>
