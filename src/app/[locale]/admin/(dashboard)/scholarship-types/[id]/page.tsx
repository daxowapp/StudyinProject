...
export default function EditScholarshipTypePage() {
    ...
    const fetchScholarshipType = useCallback(async () => {
        try {
            ...
            if (data) {
                const scholarshipData = data as unknown as ScholarshipType & { id: number; created_at: string; updated_at: string };
                setFormData({
                    name: scholarshipData.name || "",
                    display_name: scholarshipData.display_name || "",
                    description: scholarshipData.description || "",
                    tuition_coverage_percentage: scholarshipData.tuition_coverage_percentage || 0,
                    service_fee_usd: Number(scholarshipData.service_fee_usd) || 0,
                    service_fee_cny: Number(scholarshipData.service_fee_cny) || 0,
                    includes_accommodation: scholarshipData.includes_accommodation || false,
                    includes_stipend: scholarshipData.includes_stipend || false,
                    stipend_amount_monthly: Number(scholarshipData.stipend_amount_monthly) || 0,
                    benefits: scholarshipData.benefits || [],
                    requirements: scholarshipData.requirements || [],
                    is_active: scholarshipData.is_active ?? true,
                    display_order: scholarshipData.display_order || 0,
                });
            }
        } catch (error) {
