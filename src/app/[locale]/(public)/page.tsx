...
interface PageProgram {
  ...
  level: string;
  duration: string;
  tuition_fee: string; // Changed to string to match component
  currency: string;
  language: string;
  intake: string;
  university: {
...
interface PageUniversity {
  ...
  logo_url: string;
  cover_photo_url: string;
  founded: string; // Changed to string to match component
  total_students: string; // Changed to string to match component
  ranking: string; // Changed to string to match component
