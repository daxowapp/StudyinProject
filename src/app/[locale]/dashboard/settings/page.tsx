...
export default function SettingsPage() {
  ...
  const [user, setUser] = useState<{ id: string; email?: string; user_metadata: { full_name?: string; phone?: string; country?: string; passport?: string; emergency_contact_name?: string; emergency_contact_phone?: string; emergency_contact_relationship?: string; }; created_at: string; email_confirmed_at?: string } | null>(null);
