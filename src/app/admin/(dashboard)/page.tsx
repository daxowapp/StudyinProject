...
export default async function AdminDashboardPage() {
    ...
    try {
        ...
        if (recentAppsResult.status === 'fulfilled') {
            console.log("Recent Apps Query Status: Fulfilled");
            console.log("Recent Apps Data Length:", recentAppsResult.value.data?.length);
            console.log("Recent Apps Data Sample:", recentAppsResult.value.data?.[0]);
