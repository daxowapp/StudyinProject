...
export function CurrencyProvider({ children }: { children: ReactNode }) {
    ...
    // Fetch live exchange rates after a 5-second idle delay (not on initial render)
    useEffect(() => {
        ...
        // Defer initial fetch to avoid blocking page load
        const timer = setTimeout(fetchRates, 5000);
