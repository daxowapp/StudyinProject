-- =====================================================
-- FIX: Add missing score/deadline columns to v_university_programs_full
-- Date: 2026-03-11
-- Issue: gpa_requirement, application_deadline, score_ielts, score_toefl,
--        score_duolingo are saved in university_programs but NOT in the view.
-- =====================================================

-- 1. Drop and recreate the view with ALL columns
...
SELECT 
    ...
    -- Score / requirement columns (PREVIOUSLY MISSING)
    up.gpa_requirement,
